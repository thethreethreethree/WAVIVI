    ...
    <div className="flex flex-1 flex-col px-5 pt-[max(3rem,calc(env(safe-area-inset-top)+2rem))]">
      ...
      >
        {/* Frame asset visually overflows past the Link box (negative
            ...
            Theme-conditional: Light Rustic (default, no theme class) gets
            the warm watercolor stroke; every other theme falls back to
            the charcoal frame3. CSS in globals.css drives the swap. */}
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/decor/frames/Rustic_frame.png"
          alt=""
          aria-hidden
          className="susen-frame-rustic pointer-events-none relative -mx-4 block h-auto w-[calc(100%+2rem)] max-w-none select-none"
        />
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          ...
          alt=""
          aria-hidden
          className="susen-frame-default pointer-events-none relative -mx-4 hidden h-auto w-[calc(100%+2rem)] max-w-none select-none"
        />
