...
/**
 * DELETE /api/admin/experiences — bulk delete (admin).
 *   body: { ids: string[] }                  delete a specific set
 *      or { allInRegion: string }            delete every experience in a region
 *
 * Mirrors the stays/restaurants bulk-delete used by the admin list's
