  ...
  return (
    <header className="flex items-start justify-between px-5 pb-2 pt-[max(3rem,calc(env(safe-area-inset-top)+2rem))]">
      ...
      <div className="flex items-center gap-3.5">
        ...
        >
          {/* Cream wash sized to match the icon (inset-0 = full 56×56
              touch target, same footprint as the <img>). Doesn't extend
              past the icon, just sits cleanly behind it. */}
          <span
            aria-hidden
          ...
          <img
            ...
            loading="eager"
            decoding="async"
            // scale-125 so the icon's visible drawing fills the cream
            // wash instead of sitting smaller inside it (the PNGs ship
            // with transparent padding around the drawing).
