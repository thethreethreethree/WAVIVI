 ...
 *
 * On mount this component flips the sessionStorage flag, wires up the
 * "tap to dismiss" + "end of video" closes, and starts a 7-second safety
 * timer so a broken video never traps the user.
 *
 * Autoplay requires the video to be muted + playsInline (iOS); both set.
 */
