...
- [ ] End-to-end signup → profile-created flow (RLS verified)
- [ ] Email-confirm + magic-link or password reset flow
- [ ] Sign-out from `/settings`
- [ ] Session refresh works across server / client / middleware
...
- [ ] Migration: `groups`, `group_members`, `messages` tables + RLS
- [ ] Supabase Realtime subscription in `chat-thread.tsx`
- [ ] Join / leave group
- [ ] Members page reads real group_members
